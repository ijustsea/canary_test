...
# 8. 사용하지 않는 이미지 레이어 일괄 삭제 (빌드 후 찌꺼기 정리)
echo "🧹 빌드 중 생성된 임시 이미지 정리 중..."
